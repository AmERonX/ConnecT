...
const filepath = "c:\\Projects\\ConnecT\\frontend\\dashboard.html";
let content = fs.readFileSync(filepath, 'utf8');

const old_welcome = `      <!-- Welcome -->
...
if (content.includes(old_welcome)) {
    content = content.replace(old_welcome, new_welcome);
} else {
    console.log("Welcome block not found");
}
...
if (content.includes(old_stats)) {
    ...
    console.log("Stats block not found");
}

fs.writeFileSync(filepath, content, 'utf8');
console.log("Finished updates to dashboard.html");
