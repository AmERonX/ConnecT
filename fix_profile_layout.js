...
const filepath = 'c:\\Projects\\ConnecT\\frontend\\profile.html';
let content = fs.readFileSync(filepath, 'utf-8');

const regex = /<div class="profile-body-grid stagger">[\s\S]*?<\/div>\s*<\/main>/;

const newBlock = `<div class="profile-body-grid stagger">
...
if (regex.test(content)) {
  ...
  console.log("Updated profile layout successfully.");
} else {
